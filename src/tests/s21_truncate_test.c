...
START_TEST(s21_truncate_test_1) {
  ...
  int result = s21_truncate(value_1, &result_value);
  printf("TRUNC TEST 1\n");
  printf("err_code: %d\n", result);
...
START_TEST(s21_truncate_test_7) {
  ...
  int result = s21_truncate(value_1, NULL);
  printf("TRUNC TEST 7\n");
  printf("err_code: %d\n", result);
...
Suite *s21_truncate_tests(void) {
  Suite *suite = suite_create("s21_truncate_tests_suite");
  TCase *tcase = tcase_create("s21_truncate_tests_tcase");
